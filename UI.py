...
def CreateLeaveTypeChoices():
    leaveTypeChoices = []
    filtered_leavet_type_choices = [leaveType for leaveType in leave_db.GetLeaveTypesWithBalance() if leaveType["name"].lower() != "unpaid"]
    for leaveType in filtered_leavet_type_choices:
